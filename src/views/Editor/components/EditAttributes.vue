  ...
  <div class="edit-attributes-wrapper">
    ...
    <div v-if="selectedNode">
      <el-form label-width="80px">
        ...
        <el-form-item
          v-if="['circle', 'rect'].includes(nodeType)"
          label="x"
          prop="x"
        >
          <el-input
            v-model="attributes.x"
            @input="editAttr('x', +$event)"
          ></el-input>
        </el-form-item>
        <el-form-item
          v-if="['circle', 'rect'].includes(nodeType)"
        ...
        >
          <el-input
            v-model="attributes.y"
            @input="editAttr('y', +$event)"
          ></el-input>
        </el-form-item>
        <el-form-item
          v-if="['circle'].includes(nodeType)"
          label="半径"
          prop="radius"
        >
          <el-input
            v-model="attributes.radius"
            @input="editAttr('radius', +$event)"
          ></el-input>
        </el-form-item>
        <el-form-item
          v-if="['rect'].includes(nodeType)"
          label="宽度"
          prop="width"
        >
          <el-input
            v-model="attributes.width"
            @input="editAttr('width', +$event)"
          ></el-input>
        </el-form-item>
        <el-form-item
          v-if="['rect'].includes(nodeType)"
        ...
        <el-form-item label="边框宽度" prop="borderWidth">
          <el-input
            v-model="attributes.borderWidth"
            @input="editAttr('borderWidth', +$event)"
          ></el-input>
        </el-form-item>
        <el-form-item label="边框颜色" prop="borderColor">
          <el-input
            v-model="attributes.borderColor"
            type="color"
            @input="editAttr('borderColor', $event)"
          ></el-input>
        </el-form-item>
        <el-form-item
          v-if="['poly'].includes(nodeType)"
          label="顶点"
          prop="points"
        >
          <el-input
            v-model="attributes.points"
